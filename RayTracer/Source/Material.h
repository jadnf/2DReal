...
public:
	...
	bool Scatter(const ray_t& ray, const raycastHit_t& raycastHit, color3_t& attenuation, ray_t& scattered);
	//color3_t GetEmissive() { return color3_t{ 0,0,0 }; }
...
public:
	...
	bool Scatter(const ray_t& ray, const raycastHit_t& raycastHit, color3_t& color, ray_t& scattered) { return false; }
